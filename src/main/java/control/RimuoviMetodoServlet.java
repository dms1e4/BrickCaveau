...
@WebServlet("/RimuoviMetodoServlet")
public class RimuoviMetodoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            dao.doDelete(idMetodo, utente.getIdUtente());
            
            response.sendRedirect(request.getContextPath() + "/ProfiloServlet?success=metodo_rimosso");
